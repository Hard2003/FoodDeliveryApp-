...
async function seedData() {
  try {
    ...
    const restaurantData = [
      ...
      { name: "Dragon Feast", owner: restaurantOwners[3]._id, email: "orders@dragonfeast.com", phone: "+1234567893", description: "Authentic Chinese cuisine featuring traditional dishes and modern interpretations.", cuisineType: ["Chinese", "Asian", "Noodles"], logo: "https://images.unsplash.com/photo-1582878826629-29b7ad1cdc43?w=200&h=200&fit=crop&crop=center", bannerImage: "https://images.unsplash.com/photo-1526318896980-cf78c088247c?w=800&h=400&fit=crop", address: { addressLine1: "321 Dragon Road", city: "Food City", state: "FC", pincode: "12348" }, location: { type: "Point", coordinates: [-74.012, 40.7134] }, deliveryTime: "25-35 mins", minimumOrder: 18, rating: 4.6, totalReviews: 750, fssaiLicense: "FSSAI12345678904", gstNumber: "GST1234567893", deliveryFee: 3.49, isPureVeg: false },
      ...
      { name: "Ramen Republic", owner: restaurantOwners[13]._id, email: "orders@ramenrepublic.com", phone: "+1234567803", description: "Slow-broth ramen bowls with house-made noodles and toppings.", cuisineType: ["Japanese", "Ramen"], logo: "https://images.unsplash.com/photo-1569718212165-3a8278d5f624?w=200&h=200&fit=crop&crop=center", bannerImage: "https://images.unsplash.com/photo-1591814468924-caf88d1232e1?w=800&h=400&fit=crop", address: { addressLine1: "66 Noodle St", city: "Food City", state: "FC", pincode: "12358" }, location: { type: "Point", coordinates: [-74.032, 40.7154] }, deliveryTime: "20-30 mins", minimumOrder: 14, rating: 4.7, totalReviews: 910, fssaiLicense: "FSSAI12345678914", gstNumber: "GST1234567803", deliveryFee: 2.49, isPureVeg: false },
    ...
    const menuItems = [
      ...
      { restaurant: restaurants[3]._id, name: "Sweet and Sour Chicken", description: "Peppers, pineapple, and crispy chicken", category: "Entree", image: "https://images.unsplash.com/photo-1603133872878-684f208fb84b?w=400&h=300&fit=crop", foodType: "non-veg", price: 15.99 },
      { restaurant: restaurants[3]._id, name: "Kung Pao Tofu", description: "Spicy tofu with peanuts and chilies", category: "Entree", image: "https://images.unsplash.com/photo-1582878826629-29b7ad1cdc43?w=400&h=300&fit=crop", foodType: "veg", price: 13.99 },
      { restaurant: restaurants[3]._id, name: "Veg Hakka Noodles", description: "Stir-fried noodles with veggies", category: "Noodles", image: "https://images.unsplash.com/photo-1569718212165-3a8278d5f624?w=400&h=300&fit=crop", foodType: "veg", price: 12.49 },
      ...
      { restaurant: restaurants[13]._id, name: "Tonkotsu Ramen", description: "Pork broth, chashu, egg", category: "Ramen", image: "https://images.unsplash.com/photo-1591814468924-caf88d1232e1?w=400&h=300&fit=crop", foodType: "non-veg", price: 14.99 },
      { restaurant: restaurants[13]._id, name: "Miso Ramen", description: "Miso broth with corn and scallions", category: "Ramen", image: "https://images.unsplash.com/photo-1569718212165-3a8278d5f624?w=400&h=300&fit=crop", foodType: "veg", price: 13.49 },
      { restaurant: restaurants[13]._id, name: "Gyoza", description: "Pan-fried dumplings", category: "Appetizers", image: "https://images.unsplash.com/photo-1496116218417-1a781b1c416c?w=400&h=300&fit=crop", foodType: "non-veg", price: 8.49 },
